...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroTitleLine2Accent: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    storyMilestones: Schema.Attribute.Component<'common.milestone', true>;
    ...
    teamDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    teamMembers: Schema.Attribute.Relation<
      'manyToMany',
      'api::team-member.team-member'
    >;
    teamTitle: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    values: Schema.Attribute.Relation<'manyToMany', 'api::value.value'>;
    valuesTitle: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredBadge: Schema.Attribute.String & Schema.Attribute.Required;
    filtersAllLabel: Schema.Attribute.String & Schema.Attribute.Required;
    filtersCategories: Schema.Attribute.Component<'common.text-item', true>;
    heroDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    heroEyebrow: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiBlogPostPageBlogPostPage extends Struct.SingleTypeSchema {
  collectionName: 'blog_post_pages';
  info: {
    displayName: 'Blog Post Page';
    pluralName: 'blog-post-pages';
    singularName: 'blog-post-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    authorBioLabel: Schema.Attribute.String & Schema.Attribute.Required;
    backLabel: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaButton: Schema.Attribute.Component<'common.cta', false>;
    ctaDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    ctaTitle: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::blog-post-page.blog-post-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    relatedTitle: Schema.Attribute.String & Schema.Attribute.Required;
    shareLabel: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCaseStudyPageCaseStudyPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    clientLabel: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaButton: Schema.Attribute.Component<'common.cta', false>;
    ctaDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    ctaTitle: Schema.Attribute.String & Schema.Attribute.Required;
    durationLabel: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearLabel: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactInfo: Schema.Attribute.Component<'common.contact-info', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    formFields: Schema.Attribute.Component<'common.form-field', true>;
    formPrivacyNote: Schema.Attribute.Text & Schema.Attribute.Required;
    formSubmitLabel: Schema.Attribute.String & Schema.Attribute.Required;
    formSuccessMessage: Schema.Attribute.Text & Schema.Attribute.Required;
    formSuccessTitle: Schema.Attribute.String & Schema.Attribute.Required;
    formTextareaLabel: Schema.Attribute.String & Schema.Attribute.Required;
    formTextareaPlaceholder: Schema.Attribute.String &
      Schema.Attribute.Required;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    navigation: Schema.Attribute.Component<'common.navigation', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    portfolioSection: Schema.Attribute.Component<
      'home.portfolio-section',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Relation<'manyToMany', 'api::service.service'>;
    servicesMarqueeItems: Schema.Attribute.Component<'common.text-item', true>;
    servicesSection: Schema.Attribute.Component<'home.services-section', false>;
...
export interface ApiReferencePageReferencePage extends Struct.SingleTypeSchema {
  collectionName: 'reference_pages';
  info: {
    displayName: 'Reference Page';
    pluralName: 'reference-pages';
    singularName: 'reference-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reference-page.reference-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiReferenceReference extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nextProject: Schema.Attribute.Relation<
      'oneToOne',
      'api::reference.reference'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceDetailPageServiceDetailPage
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    includesEyebrow: Schema.Attribute.String & Schema.Attribute.Required;
    includesTitle: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    statsCtaButton: Schema.Attribute.Component<'common.cta', false>;
    statsCtaDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    statsCtaTitle: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    process: Schema.Attribute.Component<'common.process-step', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    listCtaButton: Schema.Attribute.Component<'common.cta', false>;
    listCtaDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    listCtaTitle: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::blog-post-page.blog-post-page': ApiBlogPostPageBlogPostPage;
      'api::blog-post.blog-post': ApiBlogPostBlogPost;
      'api::case-study-page.case-study-page': ApiCaseStudyPageCaseStudyPage;
      'api::contact-page.contact-page': ApiContactPageContactPage;
      'api::global.global': ApiGlobalGlobal;
      'api::home-page.home-page': ApiHomePageHomePage;
      'api::reference-page.reference-page': ApiReferencePageReferencePage;
